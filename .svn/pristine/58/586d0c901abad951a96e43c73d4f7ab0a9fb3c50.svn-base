...
public class WmsSysDictData implements BaseEntity {
	...
	private java.math.BigDecimal weighted_value;
	...
	*/	
	...
	public java.math.BigDecimal getWeighted_value () {
		return weighted_value;
	}
	
	public void setWeighted_value (java.math.BigDecimal obj) {
		weighted_value = obj;
	}
	...
	*/
	public void putInMap(Map<String, Object> paramMap) {
		...
		paramMap.put("weighted_value", this.weighted_value);
