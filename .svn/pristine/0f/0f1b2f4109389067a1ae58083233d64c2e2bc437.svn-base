package com.zx.moa.util.gen.entity.ioa;

import java.sql.Date;
import java.sql.Timestamp;

public class PmPersonnel
{
    ...
    public String getPersonnel_attendancecode()
    {
        return personnel_attendancecode;
    }

    public void setPersonnel_attendancecode(String personnel_attendancecode)
    {
        this.personnel_attendancecode = personnel_attendancecode;
    }
    ...
    public Date getPersonnel_birthtime()
    {
        return personnel_birthtime;
    }

    public void setPersonnel_birthtime(Date personnel_birthtime)
    {
    ...
    public Date getPersonnel_identitytime()
    {
        return personnel_identitytime;
    }

    public void setPersonnel_identitytime(Date personnel_identitytime)
    {
    ...
    public Date getPersonnel_entrancetime()
    {
        return personnel_entrancetime;
    }

    public void setPersonnel_entrancetime(Date personnel_entrancetime)
    {
        this.personnel_entrancetime = personnel_entrancetime;
    }

    public Date getPersonnel_graduatetime()
    {
        return personnel_graduatetime;
    }

    public void setPersonnel_graduatetime(Date personnel_graduatetime)
    {
    ...
    public Date getPersonnel_trialstarttime()
    {
        return personnel_trialstarttime;
    }

    public void setPersonnel_trialstarttime(Date personnel_trialstarttime)
    {
        this.personnel_trialstarttime = personnel_trialstarttime;
    }

    public Date getPersonnel_trialendtime()
    {
        return personnel_trialendtime;
    }

    public void setPersonnel_trialendtime(Date personnel_trialendtime)
    {
        this.personnel_trialendtime = personnel_trialendtime;
    }

    public Date getPersonnel_traintime()
    {
        return personnel_traintime;
    }

    public void setPersonnel_traintime(Date personnel_traintime)
    {
    ...
    public Date getPersonnel_positivetime()
    {
        return personnel_positivetime;
    }

    public void setPersonnel_positivetime(Date personnel_positivetime)
    {
    ...
    public Date getPersonnel_contractstarttime()
    {
        return personnel_contractstarttime;
    }

    public void setPersonnel_contractstarttime(Date personnel_contractstarttime)
    {
        this.personnel_contractstarttime = personnel_contractstarttime;
    }

    public Date getPersonnel_contractendtime()
    {
        return personnel_contractendtime;
    }

    public void setPersonnel_contractendtime(Date personnel_contractendtime)
    {
    ...
    public Integer getPersonnel_salary()
    {
        return personnel_salary;
    }

    public void setPersonnel_salary(Integer personnel_salary)
    {
        this.personnel_salary = personnel_salary;
    }
    ...
    public String getPersonnel_shortTel()
    {
        return personnel_shortTel;
    }

    public void setPersonnel_shortTel(String personnel_shortTel)
    {
        this.personnel_shortTel = personnel_shortTel;
    }
    ...
    // 考勤编号
    private String personnel_attendancecode;
    ...
    // 出生日期
    private Date personnel_birthtime;

    // 身份证号
    private String personnel_identitycode;

    // 身份证有效期
    private Date personnel_identitytime;
    ...
    // 入学日期
    private Date personnel_entrancetime;

    // 毕业日期
    private Date personnel_graduatetime;
    ...
    // 试用开始日期
    private Date personnel_trialstarttime;

    // 试用结束日期
    private Date personnel_trialendtime;

    // 培训登记时间
    private Date personnel_traintime;
    ...
    // 转正时间
    private Date personnel_positivetime;
    ...
    // 合同签订日期
    private Date personnel_contractstarttime;

    // 合同截止日期
    private Date personnel_contractendtime;
    ...
    // 员工状态(0:试用、1:在职、2:实习、3:离职、4:离退休、5:异动、7:兼职)
    ...
    // 员工薪资
    private Integer personnel_salary;
    ...
    // 集团号
    private String personnel_shortTel;
    ...
    /**
     * @param head_img_path the head_img_path to set
     */
