...
public class JsonUtil {
    ...
    * */
    ...
    public static class BigIntegerAdapter implements
    JsonDeserializer<java.math.BigInteger> {
    ...
    public static class LongAdapter implements
    ...
    public static class BigDecimalAdapter implements
     JsonDeserializer<java.math.BigDecimal> {
    ...
    public static List<Map<String, Object>> jsonstrToListMap(String str)
    {
        ...
        {
            Object o = ja.get(i);
            Map<String, Object> map = jsonstrToMap(o.toString());
            list.add(map);
        }
        return list;
    }
