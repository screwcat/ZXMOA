...
public interface DocumentsDao {
    ...
    /**
     * @Title: getSysLogByOrderNo
     * @Description: 通过单号查询撤销日志
     * @param map
     * @return 
     * @author: sunlq
     * @time:2017年7月13日 下午4:09:43
     * history:
     * 1、2017年7月13日 sunlq 创建方法
     */
    public List<Map<String, Object>> getSysLogByOrderNo(Map<String, Object> map);

    public String selectChildrenApplyTypeInfo(Integer id);
    
    public List<Map<String, Object>> selectActualHolidayTimeMoa(String order_id);
