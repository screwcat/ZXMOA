...
import com.zx.moa.util.gen.entity.wms.WmsCreCreditNotaryWarn;
...
public interface WmsCreCreditNotaryWarnDao extends BaseDao<WmsCreCreditNotaryWarn> {
    ...
    */
     ...
     * @return 
     * @author: jiaodelong
     * @time:2017年3月20日 下午1:35:43
     * history:
     * 1、2017年3月20日 jiaodelong 创建方法
     */
    List<Map<String, Object>> getBizSignedCustomer(Map<String, Object> paramMap);
    /**
     * 
     * @Title: getBizMyResults
     * @Description: TODO(获取我的业绩统计信息)
     * @param salesman_shortcode
     * @return 
     * @author: handongchun
     * @time:2017年3月21日 上午11:40:46
     * history:
     * 1、2017年3月21日 handongchun 创建方法
     */
    List<Map<String, Object>> getBizMyResults(String salesman_shortcode);
    /**
     * 
     ...
     * @return 
     * @author: handongchun
     * @time:2017年3月21日 下午3:05:15
     * history:
     * 1、2017年3月21日 handongchun 创建方法
     */
    List<Map<String, Object>> getBizBillDetailed(Map<String,Object> paramsMap);
    
    /**
     * 
     * @Title: getBizStoreAmountRanking
     * @Description: TODO(获取团队、门店金额排名信息)
     * @param paramsMap
     * @return 
     * @author: handongchun
     * @time:2017年3月22日 下午4:01:26
     * history:
     * 1、2017年3月22日 handongchun 创建方法
     */
    List<Map<String,Object>> getBizStoreAmountRanking(Map<String,Object> paramsMap);
    
    /**
     * 
     * @Title: getBizStoreNumberRanking
     * @Description: TODO(获取团队、门店件数排名信息)
     * @param paramsMap
     * @return 
     * @author: handongchun
     * @time:2017年3月22日 下午4:01:29
     * history:
     * 1、2017年3月22日 handongchun 创建方法
     */
    List<Map<String,Object>> getBizStoreNumberRanking(Map<String,Object> paramsMap);
